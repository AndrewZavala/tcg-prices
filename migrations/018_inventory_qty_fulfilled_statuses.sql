-- qty_fulfilled = copies packed/sent/paid (left free stock).
-- qty_packing = planned CK lines in Need to Pack (also leave free stock — reserved).
-- qty_on_hand / qty_remaining = unreserved copies only.
